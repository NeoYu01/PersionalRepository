...
<form:form action="updateMember" method="post" modelAttribute="member">
									...
									<table border="0" cellspacing="0" cellpadding="5" class="memberTable2">
										...
										<tr>
											<td align="center" colspan="2" class="memberTd2">
												<input type="submit" value="更新" class="memberBtn" />
												&nbsp;/&nbsp;
												<input type="button" value="取消" class="memberBtn" onclick="redirectPage('/cancelEditMember');" />
											</td>
										</tr>
									</table>
								</td>
