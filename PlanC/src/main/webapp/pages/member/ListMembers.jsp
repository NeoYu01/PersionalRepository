							...
							<tr>
								<td style="width:500px;">
									<table border="0" cellspacing="0" cellpadding="5" class="memberTable2">
										...
										<tr>
											<td class="listMemberTd1"><input type="button" size="12" class="listMemberBtn2" onclick="redirectPage('/editMember?seq=${member.seq}');" /></td>
											<td class="listMemberTd2">${member.seq}</td>
											<td class="listMemberTd2">${member.id}</td>
											<td class="listMemberTd2">${member.name}</td>
											<td class="listMemberTd1"><input type="button" size="12" class="listMemberBtn1" onclick="redirectPage('/deleteMember?seq=${member.seq}');" /></td>
										</tr>
										</c:forEach>
									</table>
								</td>
